...
export interface InputFileItemProps extends VariantProps<typeof fileItem> {
  name: string
  size: number
}

export function InputFileItem({ name, size, state }: InputFileItemProps) {
      ...
      {state === 'error' ? (
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="text-sm font-extrabold text-red-600 dark:text-error-500/80">
              {name}
            </span>
          </div>
        ...
        <div className="flex flex-1 flex-col items-start gap-1">
          <div className="flex flex-col">
            ...
            <span className="dasrk:text-zinc-400 text-sm text-zinc-500">
              {formatBytes(size)}
            </span>
          </div>
